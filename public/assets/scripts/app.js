 ...
 <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <div class="text-center"><h1 class="h1c">${carrousel[0].titulo}</h1><p>${carrousel[0].descricao}</p></div>
      <a href="detalhes.html?id=2"><img class="d-block w-100" src="${carrousel[0].imagem}" alt="${carrousel[0].titulo}"></a>
      </div>
     <div class="carousel-item">
      <div class="text-center"><h1 class="h1c">${carrousel[1].titulo}</h1><p>${carrousel[1].descricao}</p></div>
      <a href="detalhes.html?id=1"><img class="d-block w-100" src="${carrousel[1].imagem}" alt="${carrousel[1].titulo}"></a>

    </div>
    <div class="carousel-item">
      <div class="text-center"><h1 class="h1c">${carrousel[2].titulo}</h1><p>${carrousel[2].descricao}</p></div>
...
const foot = {
  "id": 0,
  "sobre": "&nbsp;Me chamo Daniel Leo, tenho 23 anos e atualmente moro em Ribeirão das Neves. No momento estou cursando o primeiro periodo de  ADS ( Análize e desenvolvimento de sistemas ) na PUC-São Gabriel.<br> &nbsp;Uma das minhas paixões são obras artisticas, especialmente as do pintor Van Gogh que são as minhas favoritas e nesse site você conhecerá um pouco de suas obras mais fantásticas. Espero que goste!",
